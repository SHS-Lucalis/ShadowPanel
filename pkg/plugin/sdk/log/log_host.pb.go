...
// Instantiate a Go-defined module named "gameap-log" that exports host functions.
func Instantiate(ctx context.Context, r wazero.Runtime, hostFunctions LogService) error {
	envBuilder := r.NewHostModuleBuilder("gameap-log")
	h := _logService{hostFunctions}
...
func (h _logService) _Log(ctx context.Context, m api.Module, stack []uint64) {
