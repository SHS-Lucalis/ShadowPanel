...
// Instantiate a Go-defined module named "gameap-cache" that exports host functions.
func Instantiate(ctx context.Context, r wazero.Runtime, hostFunctions CacheService) error {
	envBuilder := r.NewHostModuleBuilder("gameap-cache")
...
func (h _cacheService) _Get(ctx context.Context, m api.Module, stack []uint64) {
...
func (h _cacheService) _Set(ctx context.Context, m api.Module, stack []uint64) {
	offset, size := uint32(stack[0]), uint32(stack[1])
	buf, err := wasm.ReadMemory(m.Memory(), offset, size)
	if err != nil {
		panic(err)
...
func (h _cacheService) _Delete(ctx context.Context, m api.Module, stack []uint64) {
	offset, size := uint32(stack[0]), uint32(stack[1])
	buf, err := wasm.ReadMemory(m.Memory(), offset, size)
	if err != nil {
		panic(err)
