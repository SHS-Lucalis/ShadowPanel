...
type ServerResponse struct {
	...
	Installed        domain.ServerInstalledStatus `json:"installed"`
...
func newGameResponse(game *domain.Game, nodeOS string) GameResponse {
...
func newGameModResponse(gameMod *domain.GameMod, nodeOS string) GameModResponse {
	var remoteRepository *string
	var localRepository *string
