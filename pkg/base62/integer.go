...
func (enc *Encoding) AppendInt(dst []byte, num int64) []byte {
	return enc.AppendUint(dst, uint64(num)) //nolint:gosec // intentional bit reinterpretation
}
...
func (enc *Encoding) ParseInt(src []byte) (int64, error) {
	...
	return int64(num), nil //nolint:gosec // intentional bit reinterpretation
}
